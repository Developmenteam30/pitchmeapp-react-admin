...
class UpdateProfile extends Component {
  ...
  showCroppedImage = async () => {
    try {
      ...
      console.log("this.state.profile_pic", this.state.setCroppedImage);
    } catch (e) {
      console.error(e);
    }
  };
  ...
  onSubmitForm = (e) => {
    ...
    let { profile_pic, errors, name, email } = this.state;
    let error;
                  ...
                  <Col xs="12">
                    ...
                    <div className="form-group">
                      ...
                      {error_photo.length > 0 ? (
                        <div className="w-100">
                          <span className="invalid-text  ">{error_photo}</span>
                        </div>
                      ) : null}
                      {profile_pic.name ? (
                        <img
                          src={this.state.pic.imageSrc}
                          alt="default-img"
                          className="showProfile"
                        />
                      ) : (
                        <img
                          src={this.props.auth.admin.profile_pic}
                          alt="default-img"
                          className="showProfile mb-4"
                        />
                      )}
                    </div>
                    <LaddaButton
